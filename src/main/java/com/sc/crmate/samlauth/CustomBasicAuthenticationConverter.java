...
public final class CustomBasicAuthenticationConverter implements AuthenticationConverter {
    ...
    /**
     * Constructs a {@link org.springframework.security.saml2.provider.service.web.Saml2AuthenticationTokenConverter} given a strategy for
     ...
     */
    public CustomBasicAuthenticationConverter(RelyingPartyRegistrationResolver relyingPartyRegistrationResolver) {
